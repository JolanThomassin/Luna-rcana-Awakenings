...
- Download the file "Lunarcana.rar"
- Unzip the file
- Launch the file "Lunarcana.exe"

> If any difficulties occur (such as windows blocking it or database loading issues), try starting the game with administrative privileges.
